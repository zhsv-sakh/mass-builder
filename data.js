...
const MEALS = [
  { id:'breakfast', emoji:'🍳', title:'Завтрак', time:'07:00', water:400,
    variants:[
      ...
      {id:'v3', name:'Овсянка + яйца', items:[
        {id:'b9',  n:'Овсянка 80 г', k:300, p:10, f:6, c:52},
        {id:'b10', n:'Яйца 3 шт', k:210, p:18, f:15, c:1},
        {id:'b11', n:'Сливочное масло 10 г', k:72, p:0, f:8, c:0}
      ]},
      {id:'v4', name:'Гречка + яйца', items:[
        {id:'b12', n:'Гречка 80 г (сухая)', k:272, p:10, f:2, c:56},
        {id:'b13', n:'Яйца 3 шт', k:210, p:18, f:15, c:1},
        {id:'b14', n:'Сливочное масло 10 г', k:72, p:0, f:8, c:0}
      ]}
    ]},
  { id:'snack1', emoji:'🥤', title:'Перекус №1', time:'10:00', water:400,
    variants:[
      ...
      {id:'v3', name:'Творог + банан', items:[
        {id:'s1c', n:'Творог 5% 150 г', k:182, p:27, f:7, c:5},
        {id:'s1d', n:'Банан 1 шт', k:105, p:1, f:0, c:27}
      ]},
      {id:'v4', name:'Творог + мёд + орехи', items:[
        {id:'s1e', n:'Творог 5% 150 г', k:182, p:27, f:7, c:5},
        {id:'s1f', n:'Мёд 1 ст.л.', k:64, p:0, f:0, c:17},
        {id:'s1g', n:'Грецкие орехи 15 г', k:98, p:2, f:10, c:2}
      ]}
    ]},
  { id:'lunch', emoji:'🍚', title:'Обед', time:'13:00', water:500,
    variants:[
      ...
      {id:'v4', name:'Рис басмати + рыба', items:[
        {id:'l4a', n:'Рис басмати 150 г (сухой)', k:520, p:11, f:1, c:115},
        {id:'l4b', n:'Рыба (треска/минтай) 250 г', k:205, p:45, f:2, c:0},
        {id:'l4c', n:'Овощи салат 200 г', k:60, p:3, f:1, c:10},
        {id:'l4d', n:'Оливковое масло 1 ст.л.', k:120, p:0, f:14, c:0}
      ]},
      {id:'v5', name:'Рис + индейка', items:[
        {id:'l5a', n:'Рис 150 г (сухой)', k:520, p:11, f:1, c:115},
        {id:'l5b', n:'Индейка 200 г', k:300, p:58, f:6, c:0},
        {id:'l5c', n:'Овощи салат 200 г', k:60, p:3, f:1, c:10},
        {id:'l5d', n:'Оливковое масло 1 ст.л.', k:120, p:0, f:14, c:0}
      ]}
    ]},
  { id:'snack2', emoji:'🍌', title:'Перекус №2', time:'16:30', water:400,
    variants:[
      ...
      {id:'v3', name:'Протеин + 2 банана', items:[
        {id:'s4c', n:'Протеин 1 скуп', k:120, p:24, f:1, c:3},
        {id:'s4d', n:'Банан 2 шт', k:210, p:2, f:0, c:54}
      ]},
      {id:'v4', name:'Творог + мёд', items:[
        {id:'s4e', n:'Творог 5% 150 г', k:182, p:27, f:7, c:5},
        {id:'s4f', n:'Мёд 1 ст.л.', k:64, p:0, f:0, c:17}
      ]}
    ]},
  { id:'dinner', emoji:'🍗', title:'Ужин', time:'19:30', water:500,
    variants:[
      ...
      {id:'v4', name:'Курица + картофель', items:[
        {id:'d4a', n:'Куриная грудка 200 г', k:330, p:62, f:7, c:0},
        {id:'d4b', n:'Картофель 300 г', k:231, p:6, f:0, c:51},
        {id:'d4c', n:'Овощи 200 г', k:60, p:3, f:1, c:10},
        {id:'d4d', n:'Сливочное масло 5 г', k:36, p:0, f:4, c:0}
      ]},
      {id:'v5', name:'Курица + бурый рис', items:[
        {id:'d5a', n:'Куриная грудка 200 г', k:330, p:62, f:7, c:0},
        {id:'d5b', n:'Бурый рис 120 г (сухой)', k:408, p:10, f:3, c:86},
        {id:'d5c', n:'Овощи 200 г', k:60, p:3, f:1, c:10}
      ]}
    ]},
  { id:'night', emoji:'🌙', title:'На ночь', time:'22:30', water:300,
    variants:[
      ...
      {id:'v3', name:'Протеин', items:[
        {id:'n3a', n:'Протеин 1 скуп', k:120, p:24, f:1, c:3}
      ]},
      {id:'v4', name:'Творог + кефир + орехи', items:[
        {id:'n4a', n:'Творог 5% 150 г', k:182, p:27, f:7, c:5},
        {id:'n4b', n:'Кефир 1% 200 мл', k:80, p:6, f:2, c:8},
        {id:'n4c', n:'Грецкие орехи 15 г', k:98, p:2, f:10, c:2}
      ]}
    ]}
];
